...
# pbmc.data <- cm
# pbmc <- CreateSeuratObject(counts = cm, project = "scCourse2019", min.cells = 3, min.features = 200)

# see prepIlluminaData.Rmd for how to create
load("pbmc5k.seurat.RData")
pbmc.data <- GetAssayData(pbmc)
```
...
```{r qc2, fig.height=7, fig.width=13, warning=TRUE, paged.print=TRUE}
...
saveRDS(pbmc, file = "scCourse2019.seurat.1.rds")
```
